...
func (_q *ResultQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *ResultQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *ResultQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *ResultQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *ResultQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *ResultQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ResultQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(result.Table, result.Columns, sqlgraph.NewFieldSpec(result.FieldID, field.TypeInt64))
	_spec.From = _q.sql
