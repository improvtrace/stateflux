...
const (
	// Label holds the string label denoting the processing type in the database.
	Label = "processing"
	...
	// Table holds the table name of the processing in the database.
	Table = "processing_tasks"
)

// Columns holds all SQL columns for processing fields.
var Columns = []string{
	FieldID,
	FieldType,
	FieldPriority,
...
// OrderOption defines the ordering options for the Processing queries.
