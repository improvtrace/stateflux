...
const (
	// Label holds the string label denoting the completed type in the database.
	Label = "completed"
	...
	// Table holds the table name of the completed in the database.
	Table = "completed_tasks"
)

// Columns holds all SQL columns for completed fields.
var Columns = []string{
	FieldID,
	FieldType,
	FieldPriority,
...
// OrderOption defines the ordering options for the Completed queries.
