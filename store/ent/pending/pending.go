...
const (
	// Label holds the string label denoting the pending type in the database.
	Label = "pending"
	...
	// Table holds the table name of the pending in the database.
	Table = "pending_tasks"
)

// Columns holds all SQL columns for pending fields.
var Columns = []string{
	FieldID,
	FieldType,
	FieldPriority,
...
// OrderOption defines the ordering options for the Pending queries.
